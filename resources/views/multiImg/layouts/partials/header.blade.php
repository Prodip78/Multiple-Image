 <!-- Custom fonts for this template-->
  ...
  <link href="{{asset('public/backend/css/image.css')}}" rel="stylesheet">
  ...
  <link href="{{asset('public/backend/vendor/datatables/dataTables.bootstrap4.css')}}" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="//cdn.ckeditor.com/4.14.0/standard/ckeditor.js.">
<link href="{{asset('public/backend/toastr.min.css')}}" rel="stylesheet" type="text/css" />
